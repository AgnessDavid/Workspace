...
<head>
  ...
  <script>
    // Redirection si l'utilisateur essaie d'ouvrir le code source
    document.addEventListener('keydown', function(event) {
      // Vérifie si l'utilisateur a appuyé sur Ctrl + U
      if (event.ctrlKey && event.key === 'u') {
        event.preventDefault(); // Empêche l'action par défaut
        window.location.href = 'autre_page.html'; // Redirige vers une autre page
      }
    });
